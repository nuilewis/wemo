...
class TransactionService{
 ...
 static Network determinNetwork(int phoneNumber){

 Network networkType = Network.mtn;
  ...
  String phoneNumToString = phoneNumber.toString();
   ...
   if(phoneNumToString.startsWith("67") || phoneNumToString.startsWith("68") || phoneNumToString.startsWith("65")){
    networkType = Network.mtn;
   } else if(phoneNumToString.startsWith("69") || phoneNumToString.startsWith("65")  ){
     networkType = Network.orange;
   }
